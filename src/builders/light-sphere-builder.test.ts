...
import {LightSphereBuilder} from './light-sphere-builder';
...
describe('The LightSphere class', () => {
  ...
  describe('The constructor', () => {
    it('should reset their properties', () => {
      // Prepare
      const spy = jest.spyOn(LightSphereBuilder.prototype, 'reset');

      //Act
      builder = new LightSphereBuilder();
  ...
  describe('The `createGeomtry` method', () => {
    ...
    describe('the `createMesh` method', () => {
      ...
      it('should throw an error when tries to create a mesh without having created a geometry yet', () => {
        // Prepare
        builder.setMaterial({color: 'rgb(255, 255, 255)'});
      ...
      it('should throw an error when tries to create a mesh without having set a material yet', () => {
        // Prepare
        builder.createGeometry();
